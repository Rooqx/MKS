...
export default function BabyBed({ favorites, setFavorites, cart, setCart }) {
  const navigate = useNavigate();
  const babyBed = updatedBabyProduct.filter((product) => {
    return product.category.toLowerCase() === "babybed";
  });
