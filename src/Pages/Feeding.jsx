...
export default function Feeding({ favorites, setFavorites, cart, setCart }) {
  const navigate = useNavigate();
  const feeding = updatedBabyProduct.filter((product) => {
    return product.category.toLowerCase() === "feeding";
  });
