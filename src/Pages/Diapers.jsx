...
export default function Category2({ favorites, setFavorites, cart, setCart }) {
  const navigate = useNavigate();
  const diapers = updatedBabyProduct.filter((product) => {
    return product.category.toLowerCase() === "diaper";
  });
