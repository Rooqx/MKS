...
export default function BabyWardrobe({
  favorites,
  setFavorites,
  cart,
  setCart,
  ...
  const wardrobe = updatedBabyProduct.filter((product) => {
    return product.category.toLowerCase() === "wardrobe";
  });
