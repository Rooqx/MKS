...
export default function BabyBath({ favorites, setFavorites, cart, setCart }) {
  const navigate = useNavigate();
  const babyBath = updatedBabyProduct.filter((product) => {
    return product.category.toLowerCase() === "babybath";
  });
