...
export default function Category4({ favorites, setFavorites, cart, setCart }) {
  const navigate = useNavigate();
  const babyGear = updatedBabyProduct.filter((product) => {
    return (
      product.category.toLowerCase() === "babygear" ||
      product.category.toLowerCase() === "stroller"
    );
  });
