...
export default function Category5({ favorites, setFavorites, cart, setCart }) {
  const navigate = useNavigate();
  const girlCloth = updatedBabyProduct.filter((product) => {
    return product.category.toLowerCase() === "girlscloth";
  });
