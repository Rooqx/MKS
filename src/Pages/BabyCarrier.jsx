...
export default function BabyCarrier({
  favorites,
  setFavorites,
  cart,
  setCart,
  ...
  const babyCarrier = updatedBabyProduct.filter((product) => {
    return product.category.toLowerCase() === "babycarrier";
  });
