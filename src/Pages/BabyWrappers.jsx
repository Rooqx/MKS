...
export default function BabyWrappers({
  favorites,
  setFavorites,
  cart,
  setCart,
  ...
  const wrapper = updatedBabyProduct.filter((product) => {
    return product.category.toLowerCase() === "backwrapper";
  });
