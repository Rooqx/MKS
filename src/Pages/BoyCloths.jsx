...
export default function Category6({ favorites, setFavorites, cart, setCart }) {
  const navigate = useNavigate();
  const boyCloth = updatedBabyProduct.filter((product) => {
    return product.category.toLowerCase() === "boyscloth";
  });
